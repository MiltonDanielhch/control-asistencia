										...
										<td >{{ $asistencia->miembro->nombre_apellido }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('asistencias.destroy', $asistencia->id) }}" method="POST">
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm" onclick="event.preventDefault(); confirm('¿Esta seguro de eliminar este registro?') ? this.closest('form').submit() : false;"><i class="fa fa-fw fa-trash"></i></button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
